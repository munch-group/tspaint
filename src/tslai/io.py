"""Input front ends: obtain a tslai-ready tree sequence from genotypes (CLAUDE.md §5, §7.4, §9).

tslai paints any tree sequence with cross-tree node-ID stability. This namespace gathers the
...
RFMix is a *comparator* (genotype-native), not an ARG front end — see :func:`tslai.compare.rfmix_paint`.
"""
