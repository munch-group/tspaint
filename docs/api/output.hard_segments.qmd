# output.hard_segments { #tslai.output.hard_segments }

```python
tslai.output.hard_segments(track, deadband=0.0)
```
...
<code>[**track**]{.parameter-name} [:]{.parameter-annotation-sep} [[list](`list`)\[[Segment](`tslai.output.Segment`)\]]{.parameter-annotation}</code>
